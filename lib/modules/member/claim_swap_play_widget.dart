...
class ClaimSwapPlayWidget extends StatefulWidget {
  ...
  @override
  State<ClaimSwapPlayWidget> createState() => _ClaimSwapPlayWidgetState();
}

void onAutoClaimSwapPlayKitty(BuildContext context, List<Map<String, String>> members) {
...
class _ClaimSwapPlayWidgetState extends State<ClaimSwapPlayWidget> {
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: () async {
                            onAutoClaimSwapPlayKitty(contextMain, widget.members);
                          },
                          child: const Text(
